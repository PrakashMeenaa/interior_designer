  ...
  return (
    <div className="bg-primary tracking-widest leading-normal font-thin pt-24 pb-24 mx-2 sm:px-16 md:px-32  ">
      ...
      <div className="flex flex-col sm:grid sm:grid-flow-col sm:grid-cols-3 gap-4">
        <div className="group cursor-pointer flex flex-col gap-8 py-14 px-8 border-2 border-opacity-20 border-third relative">
          <div className="">
            ...
            <hr className="child w-12 mt-2 opacity-20 "/>
          </div>
